...
def run_dispersion_model(config: ModelConfig, bounds: Optional[Tuple] = None):
    ...
    # DOPO (nuovo, standardizzato a 1D)
    return C1, (x, y, z), times, stability, wind_dir, stability_label, wind_label, (puffs if config.dispersion_model == DispersionModelType.PUFF else None)
